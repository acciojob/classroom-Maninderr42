...
public class StudentController {
    ...
    public ResponseEntity<String> addStudent(@RequestBody Student student){
     studentService.seStReObj(student);
        return new ResponseEntity<>("New student added successfully", HttpStatus.CREATED);
    }

    @PostMapping("/add-teacher")
    public ResponseEntity<String> addTeacher(@RequestBody Teacher teacher){
        studentService.seteReObj(teacher);
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name){
        Teacher teacher = studentService.getTeacherName(name); // Assign student by calling service layer method
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        studentService.deleteByNameTeacher(teacher);
